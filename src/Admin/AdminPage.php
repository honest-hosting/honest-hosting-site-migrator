...
class AdminPage {
	...
	public function render_page(): void {
		...
		$hh_view = array(
			...
			'compression'       => (string) get_option( 'hh_migrator_compression', 'auto' ),
			'destination_id'    => (string) get_option( 'hh_migrator_destination_site_id', '' ),
			'destination_name'  => (string) get_option( 'hh_migrator_destination_site_name', '' ),
			'destination_url'   => (string) get_option( 'hh_migrator_destination_site_url', '' ),
